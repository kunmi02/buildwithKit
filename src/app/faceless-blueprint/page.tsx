    ...
    <main className="min-h-screen overflow-x-clip bg-[#0f1515] text-[#e8ecec]">
        ...
        <div className="mx-auto grid min-w-0 max-w-7xl items-center gap-12 lg:grid-cols-[1fr_0.85fr]">
          <div className="min-w-0">
            ...
            <p className="mt-4 text-sm text-[#9aa3a3]">
              One-time $10. One merged PDF. Instant download. No subscription.
            </p>
          </div>
      ...
      <section className="border-y border-white/10 bg-[#111818] px-5 py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-10 text-xl font-bold text-white">
            The gap isn’t talent. It’s a finished plan you can execute tonight.
          </p>
        </div>
      </section>
      ...
      <section id="offer" className="bg-[#111818] px-5 py-20">
        <SectionHeader
          ...
          title="Everything you get — stacked, priced, and stupid-cheap at $10."
          subtitle="This isn’t a vague ebook. It’s one complete playbook — every blueprint, prompt, calendar, and bonus merged into a single PDF. One payment. One download. No hunting through scattered files."
        />
        <div className="mx-auto max-w-4xl space-y-4">
          {offerStack.map((item, index) => (
            ...
            >
              ...
              <div className="shrink-0 text-right">
                <p className="text-sm text-[#9aa3a3]">Value</p>
          ...
          <div className="rounded-[1.6rem] border-2 border-[#77b255]/40 bg-[#151d1d] p-8 text-center md:p-10">
            <div className="flex flex-col items-center justify-center gap-2 sm:flex-row sm:gap-6">
              <div>
                <p className="text-sm text-[#9aa3a3]">Total value</p>
              ...
              <div>
                <p className="text-sm font-black uppercase tracking-[0.2em] text-[#77b255]">Your price today</p>
                <p className="text-5xl font-black text-white md:text-6xl">$10</p>
              </div>
            </div>
            <p className="mx-auto mt-6 max-w-xl text-[#aeb7b7]">
              Less than two coffees. One decision. A channel plan you can execute tonight — not “someday when I’m ready.”
            </p>
            <CheckoutLink className="mt-8 inline-flex rounded-full bg-[#77b255] px-10 py-4 font-black text-[#101515] shadow-glow hover:bg-[#8ed36a]">
          ...
          <div className="rounded-[1.6rem] border border-white/10 bg-[#151d1d] p-8">
            ...
            <ul className="mt-5 space-y-3 text-[#aeb7b7]">
              {[
                ...
                "Ten dollars feels like a big bet — this is a starter kit, not a magic button",
              ].map((item) => (
                <li key={item} className="flex gap-3">
      ...
      <section id="pricing" className="bg-[#111818] px-5 py-20">
        <div className="mx-auto max-w-5xl rounded-[2rem] border border-white/10 bg-[#151d1d] p-8 text-center shadow-2xl md:p-14">
          <p className="mb-3 text-sm font-black uppercase tracking-[0.25em] text-[#77b255]">Reverse the risk</p>
          <h2 className="text-3xl font-black leading-tight md:text-5xl">
            $10. One payment. If it’s not worth it, you’re out less than lunch.
          </h2>
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-[#aeb7b7]">
            No subscription trap. No hidden upsell waiting after checkout. Download one complete PDF — 10 blueprints, prompts, 30-day calendar, and clipping bonus, all merged — and decide if it’s the push you needed. Worst case: you lost the price of a sandwich. Best case: you finally launch.
          </p>
          <div className="mt-8 flex flex-col items-center justify-center gap-2">
            <p className="text-sm text-[#9aa3a3] line-through">Total stack value: $1,181</p>
            <p className="text-6xl font-black md:text-7xl">$10</p>
            <p className="text-sm font-black uppercase tracking-[0.2em] text-[#77b255]">One-time · Instant access</p>
          </div>
          <CheckoutLink className="mt-8 inline-flex rounded-full bg-white px-10 py-4 font-black text-[#101515] hover:bg-[#d8dde0]">
            Download the Playbook — $10
          </CheckoutLink>
      ...
      <section id="faq" className="px-5 py-20">
        <SectionHeader
          ...
          subtitle="Read these before you talk yourself out of ten dollars and another month of “almost starting.”"
        />
        <div className="mx-auto grid max-w-5xl gap-5 md:grid-cols-2">
          {[
            ...
            [
              "Why is it only $10?",
              "It’s a low-friction entry point — the full launch playbook in one file, not a high-ticket program. The price is stupid on purpose: one decision, no “let me think about it for two weeks.”",
            ],
            [
            ...
            [
              "Can I get a refund?",
              "See the refund policy on this site. At $10, the bet is small — download it tonight and see if it’s the structure you’ve been missing.",
            ],
          ].map(([q, a]) => (
        ...
        <div className="mx-auto mt-12 max-w-3xl text-center">
          <p className="text-2xl font-black leading-snug md:text-3xl">
            You’ve read the offer. You know what’s in the file.
          </p>
          <p className="mt-4 text-lg text-[#aeb7b7]">
            Ten dollars. One file. One niche. Thirty days mapped. No more “I’ll start when I’m ready.”
          </p>
          <CheckoutLink className="mt-8 inline-flex rounded-full bg-[#77b255] px-10 py-4 font-black text-[#101515] shadow-glow hover:bg-[#8ed36a]">
            Get Instant Access — $10
          </CheckoutLink>
